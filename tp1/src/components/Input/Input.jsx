  ...
  return (
    <div className="d-flex justify-content-center mb-3 align-items-center">
      <input
        ...
        value={
          inputValue /*<--El valor del input será el contenido de la variable inputValue*/
        }
        onChange={
          handleChange /*<--Cuando cambie el valor del input, se invoca la función handleChange */
        }
      />
      <Button
        variant="success"
        size="sm"
        onClick={
          handleAddTask /*<--Al clickear el botón, se invoca la función handleAddTask */
        }
